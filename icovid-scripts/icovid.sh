...
# mkdir /home/vale/datagov/icovid/scripts/archivos-step-one/${EXECUTIONDATE};
# mkdir /home/vale/datagov/icovid/scripts/archivos-step-two/${EXECUTIONDATE};
cd /home/vale/datagov/icovid/scripts;
mkdir /home/vale/datagov/icovid/scripts/archivos-step-one/${EXECUTIONDATE};
mkdir /home/vale/datagov/icovid/scripts/archivos-step-two/${EXECUTIONDATE};
...
# /home/vale/datagov/icovid/scripts/backup/generated/
if [ ! -d "${PATHDOCVALE}/ICOVID/resumen/${EXECUTIONDATEBACKUP}" ]; then
  mkdir /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP};
  cp /home/vale/datagov/icovid/scripts/archivos-step-one/${EXECUTIONDATE}/*.xlsx /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP};
  cp /home/vale/datagov/icovid/scripts/archivos-step-two/${EXECUTIONDATE}/*.xlsx /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP};
else
  mkdir /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP}_${UNIXTIME};
  mv /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP}/* /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP}_${UNIXTIME};
  cp /home/vale/datagov/icovid/scripts/archivos-step-one/${EXECUTIONDATE}/*.xlsx /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP};
  cp /home/vale/datagov/icovid/scripts/archivos-step-two/${EXECUTIONDATE}/*.xlsx /home/vale/datagov/icovid/scripts/backup/generated/${EXECUTIONDATEBACKUP};
fi
...
# /home/vale/datagov/icovid/scripts/backup/repo/
