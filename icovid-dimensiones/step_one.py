...
uso_camas_uci_covid19_nacional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension4/ucicovid/nacional/Uso%20de%20camas%20UCI%20Covid-19%20Nacional.csv"
...
#### URLS ####
carga_regional_ajustada = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension1/carga/regional/carga.regional.ajustada.csv"
r_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension1/R/regional/r.regional_n.csv"
tasa_test_semanal_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension2/tasatest/regional/tasa%20test%20semanal%20regional.csv"
positividad_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension2/positividad/regional/Positividad%20por%20region.csv"
prob48_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension3/proptemprano/Regional/prob48.regional.csv"
lab24_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension3/laboratorio/Regional/lab24.regional.csv"
not48_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension3/notificacion/Regional/not48.regional.csv"
total72_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension3/total/Regional/total72.regional.csv"
uso_camas_uci_regional = "https://raw.githubusercontent.com/datagovuc/ICOVID/master/dimension4/uci/regional/Uso%20de%20camas%20UCI%20por%20region.csv"
...
C5_regional = C5_regional.rename(columns={"fecha_primeros_sintomas": "fecha","prop3d": "Valor", "Codigo region":"cod_region"})
...
hoy = time.strftime("%Y%m%d") #guardamos la fecha de generación del archivo en formato YYYYMMDDhhmmss
dir_path = os.path.abspath(os.path.dirname(__file__))
ruta_base = f"{dir_path}/archivos-step-one/{hoy}"

if os.path.exists(f"{dir_path}/archivos-step-one/{hoy}"):
        shutil.rmtree(f"{dir_path}/archivos-step-one/{hoy}")

os.makedirs(ruta_base)
# ruta_base = f"{os.getcwd()}/archivos-step-one/{hoy}/"

#### REGIONAL
ruta_regional_T1 = f"{ruta_base}/regional_T1_{hoy}.csv"
...
#### NACIONAL
ruta_nacional_T1 = f"{ruta_base}/nacional_T1_{hoy}.csv"
...
#### XLSX ####
ruta_regional_excel_T1 = f"{ruta_base}/regional_T1.xlsx"
ruta_nacional_excel_T1 = f"{ruta_base}/nacional_T1.xlsx"
...
#### REGIONAL
ruta_regional = f"{ruta_base}/regional_{hoy}.csv"
result_regional_final.to_csv(ruta_regional, index=False)
# regional_csv = f"regional_{hoy}.csv"

#### NACIONAL
ruta_nacional = f"{ruta_base}/nacional_{hoy}.csv"
result_nacional_final.to_csv(ruta_nacional, index=False)
# nacional_csv = f"nacional_{hoy}.csv"

#### XLSX ####
ruta_regional_excel = f"{ruta_base}/regional.xlsx"
ruta_nacional_excel = f"{ruta_base}/nacional.xlsx"
